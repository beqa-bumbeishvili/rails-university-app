...
class LecturersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lecturer" do
    assert_difference('Lecturer.count') do
      post lecturers_url, params: { lecturer: { last_name: @lecturer.last_name, name: @lecturer.name, school_id: @lecturer.school_id } }
    end
  ...
  test "should update lecturer" do
    patch lecturer_url(@lecturer), params: { lecturer: { last_name: @lecturer.last_name, name: @lecturer.name, school_id: @lecturer.school_id } }
