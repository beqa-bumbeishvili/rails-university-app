...
class LecturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lecture" do
    assert_difference('Lecture.count') do
      post lectures_url, params: { lecture: { name: @lecture.name, passing_grade: @lecture.passing_grade } }
    end
  ...
  test "should update lecture" do
    patch lecture_url(@lecture), params: { lecture: { name: @lecture.name, passing_grade: @lecture.passing_grade } }
